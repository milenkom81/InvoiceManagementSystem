...
ImageIcon img;
  ...
  lab3.setIcon(img);
    ...
    private void initComponents() {
        ...
        jLabel7.setText("DELETE CASHIER");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(53, 53, 53)
                        .addComponent(lab3, javax.swing.GroupLayout.PREFERRED_SIZE, 59, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        try {
            Product_delete ob=new Product_delete();
            ob.setVisible(true);
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(this,"Connection problem!","Connection",JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        try {
            Cashier_delete ob=new Cashier_delete();
            ob.setVisible(true);
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(this,"Connection problem!","Connection",JOptionPane.INFORMATION_MESSAGE);
        }
