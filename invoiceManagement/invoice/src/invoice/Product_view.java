...
public class Product_view extends javax.swing.JFrame {
    ...
    ResultSet rs;
    public Product_view() throws SQLException {
        initComponents();
        con=ConnDb.conLink();
      try {
            stmt=con.prepareStatement("select * from product order by p_id asc");
            rs=stmt.executeQuery();
        DefaultTableModel model=new DefaultTableModel(new String[]{"PRODUCT ID","NAME","BRAND","QUANTITY","WEIGHT","PRICE","MANUFACTURING DATE","EXPIRY DATE","DISCOUNT AVAILABLE"},0);
            while(rs.next())
    ...
    private void initComponents() {
        ...
        tab.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "PRODUCT ID", "NAME", "BRAND", "QUANTITY", "WEIGHT", "PRICE", "MANUFACTURING DATE", "EXPIRY DATE", "DISCOUNT AVAILABLE"
            }
        ));
